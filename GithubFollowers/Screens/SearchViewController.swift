...
class SearchViewController: UIViewController {
    ...
    let followersButton     = GFButton(color: .systemGreen, title: "Get Followers", systemImageName: "person.3.fill")
    ...
    @objc func pushFollowerListViewController() {
        guard isUsernameEntered else {
            presentGFAlert(title: "Empty Username", message: "Please enter an username. We need to know who to look for 😄", button: "Ok")
            return
        }
